--- The file that auto-creates documentation for `aggro.logging`.
...
---
---@param text string Any text, e.g. `"aggro.logging.ClassName"`.
---@return string # The wrapped text, e.g. `"*aggro.logging.ClassName*"`.
---
...
---    The real name for the module. e.g. `"aggro.logging"`.
---
...
---@class aggro.logging.AutoDocumentationEntry
...
---
---@param paths aggro.logging.AutoDocumentationEntry[]
...
local function main()
    ...
    local paths = {
        {
            source = vim.fs.joinpath(root, "lua", "logging.lua"),
            destination = vim.fs.joinpath(root, "doc", "logging_api.txt"),
        },
    }
